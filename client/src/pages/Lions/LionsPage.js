                    ...
                    <div className="card bg-light mx-auto" style={{ margin: "auto", width: "50%" }}>
                        <div className="card-body" style={{ height: "auto" }}>
                            ...
                            <div className="calendlyCorrection">
                                ...
                                <a href="https://www.lionsclubs.org/en/discover-our-clubs/mission-and-history" target="blank"><button style={{ background: "#fdd835", color: "rgb(45,49,66", padding: "15px", border: "2px solid lightGray", borderRadius: "10px", width: "24%", margin: "2%" }}><strong>Mission & History</strong></button></a>
